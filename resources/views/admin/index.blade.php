...
@section('css')
    <link rel="stylesheet" href="{{asset('backend/plugins/swtich-netliva/css/netliva_switch.css')}}">
@endsection
...
@section('scripts')
  <!-- Switch -->
  <script src="{{ asset('backend/plugins/swtich-netliva/js/netliva_switch.js')}}"></script>
